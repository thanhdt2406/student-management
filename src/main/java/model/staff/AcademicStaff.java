...
public class AcademicStaff extends Staff {
    ...
    public AcademicStaff(int userId, String username, String password, String name, String phoneNumber, int salary) {
        super(userId, username, password, name, phoneNumber, salary);
    }
}
